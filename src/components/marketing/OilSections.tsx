...
import { OIL_CATEGORY, type OilProductDetail } from "@/lib/content/oil-product-content";
...
export function OilProductDetailSections({ product }: { product: OilProductDetail }) {
  return (
...
export function EdibleOilsCategorySections() {
