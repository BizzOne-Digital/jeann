...
import { BEANS_CATEGORY, type PulseProductDetail } from "@/lib/content/pulse-product-content";
...
export function PulseProductDetailSections({ product }: { product: PulseProductDetail }) {
  return (
...
export function BeansCategorySections() {
